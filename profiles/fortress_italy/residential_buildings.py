...
residential_buildings = [  
    ...
    ["Independent Buildings",   "House",    0, 1, 1,    False, 3,    0.5,    2,    3, False],
    ["Independent Buildings",   "House",    0, 1, 2,    True,  2,    1.0,    2,    2, False],
    ["Independent Buildings",   "House",    0, 1, 3,    False, 4,    0.5,    2,    3, False],
    ["Independent Buildings",   "House",    0, 2, 0,    False, 3,    1.0,    1,  2, False],
    ...
    ["Independent Buildings",   "House",    0, 3, 0,    False,  1,    0.25,    4,  3, False],
    ["Independent Buildings",   "House",    0, 3, 1,    True,  3,    0.5,    3,  2, False],
    ["Independent Buildings",   "House",    0, 3, 2,    True,  4,    0.5,    3,  2, False],
    ["Independent Buildings",   "House",    0, 3, 3,    False,  4,    1.0,    1,  2, False],
    ...
    ["Independent Buildings",   "House",    1, 1, 1,    False, 3,    0.5,    3,    2, False],
    ["Independent Buildings",   "House",    1, 1, 2,    True,  2,    1.0,    2,    2, False],
    ["Independent Buildings",   "House",    1, 1, 3,    False, 4,    0.5,    3,    2, False],
    ["Independent Buildings",   "House",    1, 2, 0,    False, 3,    1.0,    2,  1, False],
    ...
    ["Independent Buildings",   "House",    1, 3, 0,    False,  1,    0.25,    3,  4, False],
    ["Independent Buildings",   "House",    1, 3, 1,    True,  3,    0.5,    2,  3, False],
    ["Independent Buildings",   "House",    1, 3, 2,    True,  4,    0.5,    2,  3, False],
    ["Independent Buildings",   "House",    1, 3, 3,    False,  4,    1.0,    2,  1, False],
