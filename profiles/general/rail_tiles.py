...
rail_tiles_dict = {
    ...
    (0, 0, 2, 1): [('u', (2,3,4)), ('d', (1,4)), ('cost', 2.0)],
    (0, 1, 2, 1): [('u', (3,4)), ('d', (1,4)), ('cost', 2.0)],
    (0, 2, 2, 1): [('u', (1,2)), ('d', (1,4)), ('cost', 2.0)],
    (0, 3, 0, 1): [('u', (1,2,3)), ('d', (1,4)), ('cost', 2.0)],
    ...
    # (1, 0, 2): [('r', (1,4)), ('l', (2,3,4)), ('cost', 2.0)],
    # (1, 1, 2): [('r', (1,4)), ('l', (3,4)), ('cost', 2.0)],
    # (1, 2, 2): [('r', (1,4)), ('l', (1,2)), ('cost', 2.0)],
    # (1, 3, 0): [('r', (1,4)), ('l', (1,2,3)), ('cost', 2.0)],
    ...
    # (2, 0, 2, 1): [('u', (1,4)), ('d', (1,2,3)), ('cost', 2.0)],
    # (2, 1, 2, 1): [('u', (1,4)), ('d', (1,2)), ('cost', 2.0)],
    # (2, 2, 2, 1): [('u', (1,4)), ('d', (3,4)), ('cost', 2.0)],
    # (2, 3, 0, 1): [('u', (1,4)), ('d', (2,3,4)), ('cost', 2.0)],
    ...
    (3, 0, 2, 1): [('r', (1,2,3)), ('l', (1,4)), ('cost', 2.0)],
    (3, 1, 2, 1): [('r', (1,2)), ('l', (1,4)), ('cost', 2.0)],
    (3, 2, 2, 1): [('r', (3,4)), ('l', (1,4)), ('cost', 2.0)],
    (3, 3, 0, 1): [('r', (2,3,4)), ('l', (1,4)), ('cost', 2.0)],
...
def build_rail_tile_df():
    ...
    for key, value in rail_tiles_dict.items():
        ...
        if len(key) == 4:
            rail_tile_df_dict['variant'].append(key[3])
        else:
            rail_tile_df_dict['variant'].append(0)
