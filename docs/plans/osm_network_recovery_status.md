...
| --- | --- | --- | --- | --- | --- |
| M0 | Semantic regression harness | Not started | Unassigned | 2026-05-15 | Add fixtures, fixture runner, road graph reconstruction, debug capture, and at least one reproducible failing road case. |
